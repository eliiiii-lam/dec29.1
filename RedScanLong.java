...
public class RedScanLong extends LinearOpMode {
    ...
    public void strafeL(double speed,
        ...
        if (opModeIsActive()) {
            ...
            // Determine new target position, and pass to motor controller
            newfLeftTarget = fl.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            newbRightTarget = br.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH);
            newbLeftTarget = bl.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            newfRightTarget = fr.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH);

            br.setTargetPosition(newbRightTarget);
            bl.setTargetPosition(newbLeftTarget);
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Running to",  " %7d :%7d", newbLeftTarget,  newbRightTarget, newfLeftTarget, newfRightTarget);
